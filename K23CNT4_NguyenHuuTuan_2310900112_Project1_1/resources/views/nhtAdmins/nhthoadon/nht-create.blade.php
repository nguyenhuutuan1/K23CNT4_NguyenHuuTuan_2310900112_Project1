                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="nhtMaLoai" id="nhtMaLoai" class="form-control">
                                    @forelse ($nhtloaisanpham as $item)
                                        <option value="{{ $item->id }}" {{ old('nhtMaLoai') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nhtTenLoai }}
                                        </option>
                                    @empty
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="radio" id="nhtTrangThai1" name="nhtTrangThai" value="0" {{ old('nhtTrangThai') == '0' ? 'checked' : '' }} />
                                    <label for="nhtTrangThai1"> Hiển Thị</label>
                                    &nbsp;
                                    <input type="radio" id="nhtTrangThai0" name="nhtTrangThai" value="1" {{ old('nhtTrangThai') == '1' ? 'checked' : '' }} />
