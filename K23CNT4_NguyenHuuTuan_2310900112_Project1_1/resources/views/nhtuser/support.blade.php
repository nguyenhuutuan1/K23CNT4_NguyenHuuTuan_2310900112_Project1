...
<body class="bg-gray-100 text-gray-800">
    <div class="container mx-auto p-6 bg-white rounded-lg shadow-lg">
        ...
        <ul class="list-disc pl-5">
            ...
            <li>Điện thoại: 0328942958</li>
            <li>Facebook: <a href="https://www.facebook.com/sans.tuan.969" target="_blank" class="text-blue-500">Facebook Profile</a></li>
            <li>Instagram: <a href="https://www.instagram.com/nguyenhuutuan_12082005/" target="_blank" class="text-blue-500">Instagram Profile</a></li>
        </ul>
    </div>
</body>
</html>